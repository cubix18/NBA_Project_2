...
SELECT 
    ...
    , PLAYER_FOULS_AVG, PLAYER_POINTS_AVG, TS_PCT, EFG_PCT, TOV_PCT, FTR, THREEPAR, ORB_PCT_EST, DRB_PCT_EST, AST_TOV_RATIO
    , TO_TIMESTAMP(CURRENT_TIMESTAMP ) AS LOAD_DATE
    , 'NBA_DB.CORE_NBA_DATA.MT_SEASON_PLAYER_STATS_WITH_DRAFT' AS SOURCE_TABLE
 FROM CTE